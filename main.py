...
from LeetCode import MaxNumOfSum
from LeetCode import countVowelStrings
...
# r = MaxNumOfSum.Solution()
# r.maxOperations([1,2,53,29,49,73,23,5], 15)

r = countVowelStrings.Solution()
r.countVowelStrings(5)
...
# 다리를 지나는 트럭
#print(bridgeOnTruck.solution(2, 10, [7,4,5,6]))
